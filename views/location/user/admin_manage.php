...
<div id="partial-article-location-user">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
			...
			array_push($columnData, array(
				...
				'buttons' => array(
					'view' => array(
						...
						'url' => 'Yii::app()->controller->createUrl("view", array("id"=>$data->primaryKey,\'plugin\'=>\'location\'))'),
					'update' => array(
						'label' => 'update',
						'imageUrl' => false,
						'options' => array(
						...
						'url' => 'Yii::app()->controller->createUrl("edit", array("id"=>$data->primaryKey,\'plugin\'=>\'location\'))'),
					'delete' => array(
						'label' => 'delete',
						'imageUrl' => false,
						'options' => array(
						...
						'url' => 'Yii::app()->controller->createUrl("delete", array("id"=>$data->primaryKey,\'plugin\'=>\'location\'))')
				),
				'template' => '{delete}',
			));

			$this->widget('application.libraries.core.components.system.OGridView', array(
				'id'=>'article-location-user-grid',
