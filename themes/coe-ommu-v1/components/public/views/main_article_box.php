		...
		<div class="team-boxes clearfix">
			...
			<div class="team-box col-md-4 animated" data-animation="fadeIn" data-animation-delay="300">
				...
				<div class="member-details light">
					...
					<!-- Position -->
					<h5><?php echo $val->views->location_id != null ? $val->views->location->province_relation->province : Yii::t('phrase', 'Indonesia');?></h5>
					<!-- Strip -->
					<div class="strip"></div>
					<!-- Member Description -->
					<p class="normal"><?php echo Utility::shortText(Utility::hardDecode($val->body), 120);?></p>
					<!-- Socials -->
					<?php /*
					<div class="socials">
						<!-- Social Link -->
