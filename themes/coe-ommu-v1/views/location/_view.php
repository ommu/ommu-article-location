...
<div class="post clearfix">
	...
	<div class="dates f-left">
		...
		<h6 class="date">
			...
			<?php echo date('d', strtotime($data->article->published_date));?>
			</span>
		...
		<div class="details">
			<ul class="t-right fullwidth">
				...
				<?php if($data->article->media_file != '') {?>
				<li>
					<?php echo $data->article->view->downloads != null ? $data->article->view->downloads : 0;?> download
				...
				if(!empty($tags)) {
					...
					<li>
						...
						foreach($tags as $key => $val) {
							$i++;?>
							<a href="<?php echo Yii::app()->createUrl('article/site/index', array('tag'=>$val->tag_TO->body));?>" title="<?php echo $val->tag_TO->body?>"><?php echo $val->tag_TO->body?></a><?php echo $i != $countTags ? ',' : '';?>
						<?php }?>
	...
	<div class="post-inner f-right">
		<!-- Header -->
		<a href="<?php echo Yii::app()->controller->createUrl('view', array('id'=>$data->article->article_id, 't'=>Utility::getUrlTitle($data->article->title)))?>">
