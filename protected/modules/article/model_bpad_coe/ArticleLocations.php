...
class ArticleLocations extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('location_id, publish, province_id, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'ommuArticleLocationTags_relation' => array(self::HAS_MANY, 'OmmuArticleLocationTag', 'location_id'),
			'ommuArticleLocationUsers_relation' => array(self::HAS_MANY, 'OmmuArticleLocationUser', 'location_id'),
		);
	}
