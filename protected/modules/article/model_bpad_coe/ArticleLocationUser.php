 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_article_location_user".
 *
...
class ArticleLocationUser extends CActiveRecord
{
	 ...
	 * @return ArticleLocationUser the static model class
	 */
	...
	{
		return 'ommu_article_location_user';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, status, location_id, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'location_relation' => array(self::BELONGS_TO, 'OmmuArticleLocations', 'location_id'),
		);
	}
