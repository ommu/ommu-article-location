 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_article_collection_category".
 *
 * The followings are the available columns in table 'ommu_article_collection_category':
 ...
 * @property ArticleCollections[] $collections
 */
class ArticleCollectionCategory extends CActiveRecord
{
	 ...
	 * @return ArticleCollectionCategory the static model class
	 */
	...
	{
		return 'ommu_article_collection_category';
	}
	...
	public function rules()
	{
		...
		return array(
			array('publish, category_name', 'required'),
			array('publish', 'numerical', 'integerOnly'=>true),
			array('category_name', 'length', 'max'=>32),
			array('creation_id, modified_id', 'length', 'max'=>11),
			array('category_desc', 'safe'),
	...
	public function search()
	{
		...
		if(!isset($_GET['ArticleCollectionCategory_sort']))
	...
	{		
		...
		if($model != null) {
			foreach($model as $key => $val)
				$items[$val->cat_id] = $val->category_name;
