 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_article_location_tag".
 *
...
class ArticleLocationTag extends CActiveRecord
{
	 ...
	 * @return ArticleLocationTag the static model class
	 */
	...
	{
		return 'ommu_article_location_tag';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, publish, location_id, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
