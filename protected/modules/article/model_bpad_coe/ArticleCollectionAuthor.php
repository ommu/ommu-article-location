 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_article_collection_author".
 *
 * The followings are the available columns in table 'ommu_article_collection_author':
 ...
 * @property ArticleCollectionAuthors[] $ArticleCollectionAuthors
 */
class ArticleCollectionAuthor extends CActiveRecord
{
	 ...
	 * @return ArticleCollectionAuthor the static model class
	 */
	...
	{
		return 'ommu_article_collection_author';
	}
	...
	public function search()
	{
		...
		$criteria->compare('t.author_name',strtolower($this->author_name),true);
		...
		if(!isset($_GET['ArticleCollectionAuthor_sort']))
