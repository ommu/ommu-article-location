...
class AdminController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = ArticleCollections::model()->findByPk(1,array(
		...
		$this->pageTitle = Yii::t('phrase', 'Article Collections');
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'ArticleCollections success created.').'</strong></div>',
						));
					} else {
