...
class CategoryController extends Controller
{
	...
	{
		$model=new ArticleCollectionCategory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ArticleCollectionCategory'])) {
			$model->attributes=$_GET['ArticleCollectionCategory'];
		}
	...
	{
		$model=new ArticleCollectionCategory;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['ArticleCollectionCategory'])) {
			$model->attributes=$_POST['ArticleCollectionCategory'];
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				ArticleCollectionCategory::model()->updateAll(array(
					'publish' => 1,
				),$criteria);
				...
				ArticleCollectionCategory::model()->deleteAll($criteria);
			}
		}
	...
	{
		$model = ArticleCollectionCategory::model()->findByPk($id);
		if($model===null)
