...
class AdminController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = ArticleLocations::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('ArticleLocations', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Article Locations');
