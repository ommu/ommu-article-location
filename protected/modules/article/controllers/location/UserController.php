...
class UserController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = ArticleLocationUser::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('ArticleLocationUser', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Article Location Users');
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'View Article Location Users');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['ArticleLocationUser'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ArticleLocationUser success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['ArticleLocationUser'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ArticleLocationUser success updated.'));
					//$this->redirect(array('view','id'=>$model->id));
					$this->redirect(array('manage'));
				}
			}
