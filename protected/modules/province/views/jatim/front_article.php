...
<div class="col-md-12 col-sm-12 col-xs-12 mt-25 mb-25">
	...
	<div class="article-list">
		<div class="col-md-12 col-sm-12 col-xs-12 box first">
			...
			<a href="<?php echo Yii::app()->controller->createUrl($controller.'/viewarticle')?>" class="title left">Ut enim ad minim veniam, quis nostrud exercitation</a>
			<div class="clear"></div>
		...
		<?php for ($i = 1; $i <= 2; $i++) { ?>
			<div class="col-md-4 col-sm-4 col-xs-6 box">
				...
				<a href="<?php echo Yii::app()->controller->createUrl($controller.'/viewarticle')?>" class="title">Ut enim ad minim veniam, quis nostrud exercitation</a>
